...
function Form(props) {
    ...
    function handleSubmit(e) {
        ...
        Object.keys(props.editableFormData).length === 0 ?
                        ...
                        props.handleSubmit({ ...formData, cardId: props.editableFormData.cardId })
    }
            ...
            <div className='form-popup-inner'>
                <form className="my-form" autoComplete="off"
                    ...
                    <div className='header'>
                        ...
                        <button type='button' className='x-btn' onClick={props.toggleNewForm}><i className='bx bx-x'></i></button>
                    </div>
